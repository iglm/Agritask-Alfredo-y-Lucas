          ...
          <Card className="text-center border-0 shadow-none bg-transparent">
              ...
              <CardContent className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground px-4">
                      Al continuar, aceptas nuestra <Link href="/legal" className="underline hover:text-primary" target="_blank">política de privacidad y tratamiento de datos</Link>.
                  </p>
              </CardContent>
              <CardFooter className="flex-col gap-4 text-center">
                <div className="text-xs text-muted-foreground mt-4">
                    ...
                    <p className="mt-2">&copy; 2024 Todos los derechos reservados.</p>
                </div>
              </CardFooter>
          </Card>
        </div>
